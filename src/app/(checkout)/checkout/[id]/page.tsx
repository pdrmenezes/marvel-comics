      ...
      <div className="px-4 md:px-6 2xl:px-0 flex justify-center items-center 2xl:mx-auto 2xl:container">
        <div className="flex flex-col justify-start items-start w-full space-y-9">
          <div className="flex justify-start flex-col items-start space-y-2">
            ...
            <p className="text-base leading-normal sm:leading-4 text-gray-600 ">Home &gt; Comics &gt; Cart &gt; Checkout</p>
          </div>
...
Cidade (obrigatório)
Estado (obrigatório)
Código postal (obrigatório. Não é preciso validação adicional)
 */}
